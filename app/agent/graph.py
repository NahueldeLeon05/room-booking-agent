...
def _system_prompt() -> str:
    ...
    return (
        ...
        "- Present a validation failure as a short Markdown blockquote, then "
        "explain the next valid action in plain text. Never change or hide the "
        "meaning of a tool result for presentation.\n\n"
